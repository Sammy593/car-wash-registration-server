        ...
        <section style="display:flex; flex-direction:column; align-items:center;">
            ...
            <article class="content_art" style="display: flex;flex-direction: column;align-items: center; padding: 20px; text-align: center;">
                <div class="text_container" style="display: flex;flex-direction: column;align-items: center;margin-bottom: 10px;">
                    ...
                    <span style="font-size: 17px;font-family: 'Arial';">Su solicitud ha sido revisada, sin embargo necesitamos que proporcione sus datos correctos para continuar con el proceso</span>
                </div>
                <div class="option_container" style="display: flex;flex-direction: column;">
                    <span style="font-family: sans-serif;font-size: 13px;">Actualiza tus datos aqui ⬇</span>
                    <div class="button" style="background-color: #0078d7;height: 40px;display: flex;justify-content: center;align-items: center;font-family: sans-serif;">
                        <a style="color:white; text-decoration:none;" href="http://52.22.2.130/hrms#/actualizarDatos;_id=${idSolicitud}">Ir a formulario</a>
                    </div>
                </div>
            </article>
        </section>
